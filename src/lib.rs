use languages::{
    Amharic, Arabic, Armenian, Bengali, Bulgarian, Catalan, Danish, Deutch, English, Finnish,
    French, Greek, Gujarati, Hindi, Italian, Japanese, Kannada, Kazakh, Language, Malayalam,
    Marathi, Portuguese, Spanish, Tamil,
};
